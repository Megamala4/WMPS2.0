...
String WrongPassword =xls.getCellData("Changable_Data", "WrongPassword", i);
			...
			w.CheckBox_2();			
			w.CheckBox_3();
			WebElement RequestedQuantity1 = driver.findElement(By.xpath("/html/body/app-root/div/div/app-material-indent-create/div/div[3]/div[1]/div/table/tbody/tr/app-transactions-pop-up[2]/div/div/div/div[2]/div/div/div[2]/div/table/tbody/tr[1]/td[6]/input"));
			RequestedQuantity1.clear();RequestedQuantity1.sendKeys("50");
			Thread.sleep(2000);  
			WebElement RequestedQuantity2 = driver.findElement(By.xpath("/html/body/app-root/div/div/app-material-indent-create/div/div[3]/div[1]/div/table/tbody/tr/app-transactions-pop-up[2]/div/div/div/div[2]/div/div/div[2]/div/table/tbody/tr[2]/td[6]/input"));
			RequestedQuantity2.clear();RequestedQuantity2.sendKeys("50");
			Thread.sleep(2000); 
			w.TITLE_SUBMIT();Thread.sleep(2000); //Select lot before submitting
			
//Onother Material Formalities
			driver.findElement(By.xpath("(//*[@title='Edit'])[2]")).click();Thread.sleep(2000);  //Edit Button
			//Selecting LotsSelecting LotsSelecting LotsSelecting LotsSelecting LotsSelecting LotsSelecting LotsSelecting LotsSelecting LotsSelecting LotsSelecting Lots
			//**********************************************************************************************************************************************************			
			w.CheckBox_3();			
			w.CheckBox_4();
			WebElement RequestedQuantity3 = driver.findElement(By.xpath("/html/body/app-root/div/div/app-material-indent-create/div/div[3]/div[1]/div/table/tbody/tr/app-transactions-pop-up[2]/div/div/div/div[2]/div/div/div[2]/div/table/tbody/tr[1]/td[6]/input"));
			RequestedQuantity3.clear();RequestedQuantity3.sendKeys("50");
			Thread.sleep(2000); 
		
			WebElement RequestedQuantity4 = driver.findElement(By.xpath("/html/body/app-root/div/div/app-material-indent-create/div/div[3]/div[1]/div/table/tbody/tr/app-transactions-pop-up[2]/div/div/div/div[2]/div/div/div[2]/div/table/tbody/tr[2]/td[6]/input"));
			RequestedQuantity4.clear();RequestedQuantity4.sendKeys("50");
			Thread.sleep(2000);  
