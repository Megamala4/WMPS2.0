...
public class TC_02_Good_Recipt_With_PO2_Split extends BaseClass
{
...
//			VendorBatchNumber.sendKeys("8596855");Thread.sleep(4000);
			...
			//**************************************
			driver.findElement(By.xpath("//input[@formcontrolname='manufactureDate']")).click();Thread.sleep(2000);
			Thread.sleep(2000);Thread.sleep(2000);Thread.sleep(2000);
			driver.findElement(By.xpath("//input[@formcontrolname='manufactureDate']")).sendKeys(DateToday);Thread.sleep(2000);
			Thread.sleep(2000);Thread.sleep(2000);Thread.sleep(2000);
			driver.findElement(By.xpath("//*[@formcontrolname='retestDate']")).sendKeys(Date1ML);Thread.sleep(2000);
			Thread.sleep(2000);Thread.sleep(2000);Thread.sleep(2000);
			driver.findElement(By.xpath("//*[@formcontrolname='expiryDate']")).sendKeys(Date6ML);Thread.sleep(2000);
			Thread.sleep(2000);Thread.sleep(2000);Thread.sleep(2000);
			//*************************************
			driver.findElement(By.xpath("//*[@formcontrolname='dcDate']")).click();Thread.sleep(2000);
			Thread.sleep(2000);Thread.sleep(2000);Thread.sleep(2000);Thread.sleep(2000);
			driver.findElement(By.xpath("//*[@formcontrolname='dcDate']")).sendKeys(DateToday);Thread.sleep(2000);
			Thread.sleep(2000);Thread.sleep(2000);Thread.sleep(2000);Thread.sleep(2000);
