...
public class TC_05_Bill_Of_Material extends BaseClass
{
...
//********************************************************************************************************************************					
			//If we select VALIDATION REQUEST in Dropdown this dynamic field Protocol_Number will come
			//VALIDATION REQUEST
			try {
...
//********************************************************************************************************************************			
			...
			MaterialName.sendKeys(MaterialMasterRM);
			...
			//Add
			driver.findElement(By.xpath("/html/body/app-root/div/div/app-bom/div/div[2]/div[2]/div/div[2]/div/div/table/tbody/tr/td[8]/button[1]")).click(); Thread.sleep(2000);		
