...
public class TC_02_Vendor_Master_Supplier extends BaseClass {
	...
	public static void Ordertypr() throws Exception {
...

		{
			...
			driver.findElement(By.xpath("//*[@formcontrolname='street']")).sendKeys("Street");
			Thread.sleep(1000);
			driver.findElement(By.xpath("//*[@formcontrolname='street1']")).sendKeys("Street1");
			Thread.sleep(1000);
			driver.findElement(By.xpath("//*[@formcontrolname='street2']")).sendKeys("Street2");
			Thread.sleep(1000);
			Select country = new Select(driver.findElement(By.xpath("//*[@formcontrolname='country']")));
			country.selectByIndex(4);
			Thread.sleep(2000);
			Select state = new Select(driver.findElement(By.xpath("//*[@formcontrolname='state']")));
			state.selectByIndex(2);
			Thread.sleep(2000);
			Select city = new Select(driver.findElement(By.xpath("//*[@formcontrolname='cityId']")));
			...
			mp.Vendor_Type_DDselect();
			mp.Vendor_Name_SK(Vendor_name);
			driver.findElement(By.xpath("//*[@formcontrolname='street']")).sendKeys("sStreet");
			Thread.sleep(1000);
			driver.findElement(By.xpath("//*[@formcontrolname='street1']")).sendKeys("sStreet1");
			Thread.sleep(1000);
			driver.findElement(By.xpath("//*[@formcontrolname='street2']")).sendKeys("sStreet2");
			Thread.sleep(1000);

			Select country1 = new Select(driver.findElement(By.xpath("//*[@formcontrolname='country']")));
			country1.selectByIndex(4);
			Thread.sleep(2000);
			Select state1 = new Select(driver.findElement(By.xpath("//*[@formcontrolname='state']")));
			state1.selectByIndex(2);
			Thread.sleep(2000);
			Select city1 = new Select(driver.findElement(By.xpath("//*[@formcontrolname='cityId']")));
			...
			driver.findElement(By.xpath("//*[@formcontrolname='street2']")).sendKeys("Street2");
			Thread.sleep(1000);
			Select country2 = new Select(driver.findElement(By.xpath("//*[@formcontrolname='country']")));
			country2.selectByIndex(4);
			Thread.sleep(2000);
			Select state2 = new Select(driver.findElement(By.xpath("//*[@formcontrolname='state']")));
			state2.selectByIndex(2);
			Thread.sleep(2000);
			Select city2 = new Select(driver.findElement(By.xpath("//*[@formcontrolname='cityId']")));
			city2.selectByIndex(2);
			Thread.sleep(2000);
			mp.Postal_Code(Postal_Code);
			w.Submit();
			w.Not_Create();
