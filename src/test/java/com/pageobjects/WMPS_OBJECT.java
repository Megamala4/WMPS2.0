...
public class WMPS_OBJECT {
	...
	// Single Save Click no try catch block used here
	...
	public void Submit_Types() throws Exception {
	...
	public WebElement Submit_Text_001;

	// *********************************************************************************************************************

	@FindBy(how = How.XPATH, using = "(//button[contains(text(),'Submit')])[2]")

	public WebElement Submit_Text_002;

	// *********************************************************************************************************************

	@FindBy(how = How.XPATH, using = "(//button[contains(text(),'Submit')])[3]")

	public WebElement Submit_Text_003;
	...
	// **************************************************************************************************
	public void SearchBoxNC(String x) throws Exception {
		WebElement Color = driver.findElement(By.xpath("//input[@type='search']"));
		JavascriptExecutor Js = (JavascriptExecutor) driver;
		Js.executeScript("arguments[0].setAttribute('style', 'background: ; border: 4px solid black;');", Color);
...
//*************************************************************************************************
	...
	public void ReceivedQuantity(String x) throws Exception {
		WebElement Color = driver.findElement(
				By.xpath("//*[@formcontrolname='receivedQuantity' or @formcontrolname='receivedQuantity']"));
		JavascriptExecutor Js = (JavascriptExecutor) driver;
		Js.executeScript("arguments[0].setAttribute('style', 'background: ; border: 4px solid black;');", Color);
	...
	public void Remarks(String x) throws Exception {
		WebElement Color = driver.findElement(By.xpath(
				"//*[@formcontrolname='remark' or @formcontrolname='Remark' or @formcontrolname='remarks' or @formcontrolname='Remarks' ]"));
		JavascriptExecutor Js = (JavascriptExecutor) driver;
		Js.executeScript("arguments[0].setAttribute('style', 'background: ; border: 4px solid black;');", Color);
	...
	public void Container_No(String x) throws Exception {
		WebElement Color = driver.findElement(By.xpath(
				"//*[@formcontrolname='numberOfContainers' or @formcontrolname='numberOfContainers' or @formcontrolname='numberOfContainers' or @formcontrolname='numberOfContainers' ]"));
		JavascriptExecutor Js = (JavascriptExecutor) driver;
		Js.executeScript("arguments[0].setAttribute('style', 'background: ; border: 4px solid black;');", Color);
	...
	public void Update_Button() throws Exception {
	...
	public void Back_Button() throws Exception {
		...
		WebElement Color = driver.findElement(By.xpath("//button[contains(text(),'Back')]"));
		JavascriptExecutor Js = (JavascriptExecutor) driver;
		Js.executeScript("arguments[0].setAttribute('style', 'background: ; border: 4px solid black;');", Color);
	...
	@FindBy(how = How.XPATH, using = "(//*[@actiontype='editAction'])[2]")
	public WebElement ActionType_EditAction_Button;

	public void ActionType_EditAction_Button() throws Exception {
		WebElement Color = driver.findElement(By.xpath("(//*[@actiontype='editAction'])[2]"));
		JavascriptExecutor Js = (JavascriptExecutor) driver;
		Js.executeScript("arguments[0].setAttribute('style', 'background: ; border: 4px solid black;');", Color);
	...
	// public void ManufactureName() throws Exception
...

	{
		...
		WebElement Color = driver.findElement(By.xpath("//select[@formcontrolname='uomId']"));
	...
	public void DD_01(String x) throws InterruptedException {
		WebElement Color = driver.findElement(By.xpath("(//*[@aria-autocomplete='list'])[1]"));
		JavascriptExecutor Js = (JavascriptExecutor) driver;
		Js.executeScript("arguments[0].setAttribute('style', 'background: ; border: 1px solid red;');", Color);
		...
		Thread.sleep(5000);
		driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
		AAA.sendKeys(Keys.ARROW_DOWN, Keys.ENTER);
		Thread.sleep(2000);
		driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
	}
	...
	// WebElement Color =
	// driver.findElement(By.xpath("(//*[@aria-autocomplete='list'])[3]"));
	// JavascriptExecutor Js = (JavascriptExecutor) driver;
	// Js.executeScript("arguments[0].setAttribute('style', 'background: ; border:
	// 1px solid red;');", Color);
	//
	...
	// WebElement Color =
	// driver.findElement(By.xpath("(//*[@aria-autocomplete='list'])[4]"));
	// JavascriptExecutor Js = (JavascriptExecutor) driver;
	// Js.executeScript("arguments[0].setAttribute('style', 'background: ; border:
	// 1px solid red;');", Color);
	//
	...
	// TT_1_AD_E
	@FindBy(xpath = "(//*[@type='text'])[1]")
	WebElement TT_111_AD_E;

	public void TT_111_AD_E(String x) throws InterruptedException {
	...
	// TT_1_AD_E
	@FindBy(xpath = "(//*[@type='text'])[1]")
	WebElement TT_1_AD2_E;

	public void TT_1_AD2_E(String x) throws InterruptedException {
		...
		TT_1_AD2_E.click();
		Thread.sleep(2000);
		TT_1_AD2_E.sendKeys(x);
		Thread.sleep(2000);
		driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
		TT_1_AD2_E.sendKeys(Keys.ARROW_DOWN, Keys.ARROW_DOWN, Keys.ENTER);
		Thread.sleep(2000);
		driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
		Thread.sleep(500);
	}
	...
	public void TT_2(String x) throws InterruptedException {
		...
		TT_2.sendKeys(x);
		Thread.sleep(500);
		TT_2.sendKeys(Keys.ARROW_DOWN, Keys.ENTER);
		Thread.sleep(500);
	}
	...
	public void TT_15_Edit(String x) throws InterruptedException {
	...
	@FindBy(xpath = "(//*[@id='r']/td[5]/input)[2]")

	WebElement Text_Y;

	public void Text_Y(String x) throws InterruptedException

	{
		WebElement Color = driver.findElement(By.xpath("(//*[@id='r']/td[5]/input)[2]"));
		JavascriptExecutor Js = (JavascriptExecutor) driver;
		Js.executeScript("arguments[0].setAttribute('style', 'background: ; border: 1px solid red;');", Color);
		Text_Y.click();// Thread.sleep(500);
		Text_Y.sendKeys(x);// Thread.sleep(500);
		Text_Y.sendKeys(Keys.ENTER);// Thread.sleep(500);
	...
	public void TEN_03(String x) throws InterruptedException {
		...
		TEN_03.click();// Thread.sleep(500);
		TEN_03.sendKeys(x);// Thread.sleep(500);
		// TEN_03.sendKeys(Keys.ENTER);// Thread.sleep(500);
	}
	...
	public void TENY_02(String x) throws InterruptedException {

		WebElement Color = driver.findElement(By.xpath("(//*[@id='r']/td[5]/input)[2]"));
		JavascriptExecutor Js = (JavascriptExecutor) driver;
		Js.executeScript("arguments[0].setAttribute('style', 'background: ; border: 1px solid red;');", Color);

		TENY_02.click();// Thread.sleep(500);
		TENY_02.sendKeys(x);// Thread.sleep(500);
		TENY_02.sendKeys(Keys.ENTER);// Thread.sleep(500);
	}
	...
	public void State_DD_VT(String x) throws Exception {
		State.click();
	...
	public void City_DD_VT(String x) throws Exception {
		CityId.click();
...

	{
		...
		AA.sendKeys(Keys.ARROW_DOWN, Keys.ENTER);
		Thread.sleep(2000);
