...
public class TC_18_Quality_Inspection_2 extends BaseClass
{
...
//Data_Mapping			
			...
			driver.findElement(By.xpath("//input[@formcontrolname='SampledQuantity']")).sendKeys("5");Thread.sleep(2000);//	less thn batch Quantity			
