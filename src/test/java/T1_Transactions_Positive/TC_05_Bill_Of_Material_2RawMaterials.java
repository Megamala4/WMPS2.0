...
public class TC_05_Bill_Of_Material_2RawMaterials extends BaseClass {
	...
	public static void Bill_Of_Material() throws Exception {
		...
		for (int i = 2; i <= 2; i++) {
			// Always Change
			// ***************************************************************************************************************
			String BPR_Number_I = xls.getCellData("Bill_Of_Material", "BPR_Number_I", i); // Material Upper Part
			...
			w.BPR_Number(BPR_Number_I);// ***********************UNIQUE
			Thread.sleep(2000);
