...
//Data_Mapping			
			...
			driver.findElement(By.xpath("//a[@id='menuNavigate']")).click();
			Thread.sleep(2000);
			driver.findElement(By.xpath("//*[contains(text(),' Transactions ')]")).click();
			Thread.sleep(2000);
			driver.findElement(By.xpath("(//*[contains(text(),' Quality-Control')])")).click();
			Thread.sleep(2000); // warehouse
			driver.findElement(By.xpath("(//*[contains(text(),'Quality Inspection ')])")).click();
			Thread.sleep(2000); // GoodsReceipt
			driver.findElement(By.xpath("//*[@id='menuNavigate']")).click();
			Thread.sleep(2000); // right align

			w.SearchBox(BatchNoFromGoodRecipt);
			driver.findElement(By.xpath("(//*[@actiontype=\"editAction\"])[2]")).click();
			Thread.sleep(2000);// ************************************

			Select Pharmacopoeia = new Select(
					driver.findElement(By.xpath("//select[@formcontrolname='pharmacopoeiaId']")));
			Pharmacopoeia.selectByIndex(2);
			Thread.sleep(2000);

			driver.findElement(By.xpath("//input[@formcontrolname='ARNumber']")).sendKeys(BatchNoFromGoodRecipt);
			Thread.sleep(2000);
