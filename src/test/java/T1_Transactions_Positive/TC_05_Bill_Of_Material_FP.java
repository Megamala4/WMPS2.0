...
public class TC_05_Bill_Of_Material_FP extends BaseClass {
	...
	public static void Bill_Of_Material() throws Exception {
		...
		for (int i = 2; i <= 2; i++) {
			...
			String MaterialMasterFP = xls.getCellData("Excel_Data", "MaterialMasterFP ", i);// Low
			...
			ProductName.sendKeys(MaterialMasterFP);
			Thread.sleep(2000);
...
//*****************************IF we want to create another material we used this below code***********************************************///////////////////////////////////////////////////////////////////			
			WebElement SemiFinished_Product1 = driver.findElement(By.xpath("(//*[@aria-autocomplete='list'])[3]"));
			SemiFinished_Product1.sendKeys(Pro.getProperty("SemiFinished_Product1"));// Change Raw materials which we
																						// given in excle& give// from
																						// Configurations
			Thread.sleep(1000);
			SemiFinished_Product1.sendKeys(Keys.DOWN, Keys.ENTER);
