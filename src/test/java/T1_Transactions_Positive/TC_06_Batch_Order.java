...
public class TC_06_Batch_Order extends BaseClass {
	...
	public static void Bill_Of_Material() throws Exception {
		...
		for (int i = 2; i <= 2; i++) {
			...
			MarketName.sendKeys("INDIA");
			Thread.sleep(2000);// should be same as of master we have given as product requirement*****
			MarketName.sendKeys(Keys.ARROW_DOWN, Keys.ENTER);
			Thread.sleep(2000);
			...
			w.CheckBox_2();
			w.CheckBox_3();
			WebElement RequestedQuantity = driver.findElement(By.xpath(
