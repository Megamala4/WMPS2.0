...
public class TC_19_Market extends BaseClass
{
	...
	public static void Ordertypr() throws Exception
	{
		...
		{ 
			...
			w.Menu();
			driver.findElement(By.xpath("(//a[contains(text(),'Market')])[1]")).click();
			w.Create();

			df.Market_Name_SK("Raw Material-RW38");//Data_1
			df.Market_Code_SK("RW38");                  //Data_2
			w.Submit();
			E_Signature("Password");

			w.SearchBox("Raw Material-RW38");        //Data1
			w.Edit_Action_Button();
			df.Market_Name_SK("Raw Material-RW38E"); //Edited_Data_1
			df.Market_Code_SK("RW388");      			   //Edited_Data_2
			Update("Password");
