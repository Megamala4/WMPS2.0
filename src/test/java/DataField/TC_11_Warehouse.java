...
public class TC_11_Warehouse extends BaseClass
{
	...
	public static void Ordertypr() throws Exception
	{
		...
		{ 
			...
			w.Menu();
			driver.findElement(By.xpath("(//*[contains(text(),'Warehouse')])[1]")).click();
			w.Create();

			df.Warehouse_SK("Raw Material-RW38");		//Data_1
			df.Description_SK("RW38");                  //Data_2
			w.Submit();
			E_Signature("Password");

			w.SearchBox("Raw Material-RW38");               //Data1
			w.Edit_Action_Button();
			df.Warehouse_SK("Raw Material-RW38E"); 			//Edited_Data_1
			df.Description_SK("RW388");      			    //Edited_Data_2
			Update("Password");
