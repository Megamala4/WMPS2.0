...
public class TC_03_Vendor_Master_Supplier_ReInitiate extends BaseClass {
	...
	public static void Ordertypr() throws Exception {
		...
		for (int i = 2; i <= rowcount; i++) {
			...
			mp.Vendor_Master();
			// **************************************************************************************************
			w.SearchBox(Vendor_Name_Supplier);//SEARCHING 
			// **************************************************************************************************
			w.Edit_Action_Button();
			// **************************************************************************************************
			mp.Vendor_Name_SK(Vendor_Name_Supplier_Edit);// Vendor_Name_Manufacturer_Edit
			// **************************************************************************************************
